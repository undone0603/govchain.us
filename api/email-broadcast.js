// /api/email-broadcast - Segmented email broadcast for GovChain
  ...
  try {
    ...
    for (const user of users || []) {
      ...
      const r = await fetch('https://api.resend.com/emails', {
        ...
        body: JSON.stringify({ from: 'GovChain <hello@govchain.us>', to: user.email, subject, html: personalizedHtml }),
      });
