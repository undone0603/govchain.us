export default {
  async fetch(request, env) {
    ...
    const milestones = [
      { days: 7, label: 'Week Monitor', achieved: (stats.streak_days || 0) >= 7 },
      { days: 30, label: 'Monthly Tracker', achieved: (stats.streak_days || 0) >= 30 },
      { days: 90, label: 'Quarter Contractor', achieved: (stats.streak_days || 0) >= 90 },
      { days: 365, label: 'Annual Gov Pro', achieved: (stats.streak_days || 0) >= 365 },
    ];
